...
public partial class @PlayerInputControls : IInputActionCollection2, IDisposable
{
    ...
    public struct AgentActions
    {
        ...
        public void SetCallbacks(IAgentActions instance)
        {
            if (m_Wrapper.m_AgentActionsCallbackInterface != null)
            {
                ...
                @Look.started -= m_Wrapper.m_AgentActionsCallbackInterface.OnLook;
                @Look.performed -= m_Wrapper.m_AgentActionsCallbackInterface.OnLook;
                @Look.canceled -= m_Wrapper.m_AgentActionsCallbackInterface.OnLook;
                @Run.started -= m_Wrapper.m_AgentActionsCallbackInterface.OnRun;
                @Run.performed -= m_Wrapper.m_AgentActionsCallbackInterface.OnRun;
                @Run.canceled -= m_Wrapper.m_AgentActionsCallbackInterface.OnRun;
                @CrouchToggle.started -= m_Wrapper.m_AgentActionsCallbackInterface.OnCrouchToggle;
                @CrouchToggle.performed -= m_Wrapper.m_AgentActionsCallbackInterface.OnCrouchToggle;
                @CrouchToggle.canceled -= m_Wrapper.m_AgentActionsCallbackInterface.OnCrouchToggle;
                ...
                @Aim.started -= m_Wrapper.m_AgentActionsCallbackInterface.OnAim;
                @Aim.performed -= m_Wrapper.m_AgentActionsCallbackInterface.OnAim;
                @Aim.canceled -= m_Wrapper.m_AgentActionsCallbackInterface.OnAim;
                @Shoot.started -= m_Wrapper.m_AgentActionsCallbackInterface.OnShoot;
                @Shoot.performed -= m_Wrapper.m_AgentActionsCallbackInterface.OnShoot;
                @Shoot.canceled -= m_Wrapper.m_AgentActionsCallbackInterface.OnShoot;
                @Escape.started -= m_Wrapper.m_AgentActionsCallbackInterface.OnEscape;
                @Escape.performed -= m_Wrapper.m_AgentActionsCallbackInterface.OnEscape;
                @Escape.canceled -= m_Wrapper.m_AgentActionsCallbackInterface.OnEscape;
            }
    ...
    public struct OperatorActions
    {
        ...
        public void SetCallbacks(IOperatorActions instance)
        {
            ...
            {
                @Movement.started -= m_Wrapper.m_OperatorActionsCallbackInterface.OnMovement;
                @Movement.performed -= m_Wrapper.m_OperatorActionsCallbackInterface.OnMovement;
                @Movement.canceled -= m_Wrapper.m_OperatorActionsCallbackInterface.OnMovement;
                @Rotate.started -= m_Wrapper.m_OperatorActionsCallbackInterface.OnRotate;
                @Rotate.performed -= m_Wrapper.m_OperatorActionsCallbackInterface.OnRotate;
                @Rotate.canceled -= m_Wrapper.m_OperatorActionsCallbackInterface.OnRotate;
                @Elevate.started -= m_Wrapper.m_OperatorActionsCallbackInterface.OnElevate;
                @Elevate.performed -= m_Wrapper.m_OperatorActionsCallbackInterface.OnElevate;
                @Elevate.canceled -= m_Wrapper.m_OperatorActionsCallbackInterface.OnElevate;
                @Escape.started -= m_Wrapper.m_OperatorActionsCallbackInterface.OnEscape;
                @Escape.performed -= m_Wrapper.m_OperatorActionsCallbackInterface.OnEscape;
                @Escape.canceled -= m_Wrapper.m_OperatorActionsCallbackInterface.OnEscape;
            }
